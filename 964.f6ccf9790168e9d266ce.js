"use strict";
(self["webpackChunkportfolio"] = self["webpackChunkportfolio"] || []).push([[964],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "RouterLinkWithHref": () => (/* binding */ RouterLinkWithHref),
  ...
  "ɵangular_packages_router_router_a": () => (/* binding */ ROUTER_FORROOT_GUARD),
  "ɵangular_packages_router_router_b": () => (/* binding */ routerNgProbeToken),
  "ɵangular_packages_router_router_c": () => (/* binding */ createRouterScroller),
  "ɵangular_packages_router_router_d": () => (/* binding */ provideLocationStrategy),
  "ɵangular_packages_router_router_e": () => (/* binding */ provideForRootGuard),
  "ɵangular_packages_router_router_f": () => (/* binding */ setupRouter),
  "ɵangular_packages_router_router_g": () => (/* binding */ rootRoute),
  "ɵangular_packages_router_router_h": () => (/* binding */ RouterInitializer),
  "ɵangular_packages_router_router_i": () => (/* binding */ getAppInitializer),
  "ɵangular_packages_router_router_j": () => (/* binding */ getBootstrapListener),
  "ɵangular_packages_router_router_k": () => (/* binding */ provideRouterInitializer),
  "ɵangular_packages_router_router_l": () => (/* binding */ ɵEmptyOutletComponent),
  "ɵangular_packages_router_router_m": () => (/* binding */ Tree),
  "ɵangular_packages_router_router_n": () => (/* binding */ TreeNode),
  "ɵangular_packages_router_router_o": () => (/* binding */ RouterScroller),
  "ɵassignExtraOptionsToRouter": () => (/* binding */ assignExtraOptionsToRouter),
  "ɵflatten": () => (/* binding */ flatten)
});
...
function of(...args) {
  ...
  if ((0,isScheduler/* isScheduler */.K)(scheduler)) {
    args.pop();
    return (0,scheduleArray/* scheduleArray */.r)(args, scheduler);
  } else {
    return (0,fromArray/* fromArray */.n)(args);
  }
} //# sourceMappingURL=of.js.map
// EXTERNAL MODULE: ./node_modules/rxjs/_esm2015/internal/Subject.js + 1 modules
var Subject = __webpack_require__(709);
// EXTERNAL MODULE: ./node_modules/rxjs/_esm2015/internal/util/ObjectUnsubscribedError.js
var ObjectUnsubscribedError = __webpack_require__(971);
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/BehaviorSubject.js


class BehaviorSubject extends Subject/* Subject */.xQ {
  constructor(_value) {
    super();
    this._value = _value;
  }
...
var isArray = __webpack_require__(796);
// EXTERNAL MODULE: ./node_modules/rxjs/_esm2015/internal/Subscriber.js
var Subscriber = __webpack_require__(393);
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/OuterSubscriber.js

class OuterSubscriber extends Subscriber/* Subscriber */.L {
...
var subscribeTo = __webpack_require__(444);
// EXTERNAL MODULE: ./node_modules/rxjs/_esm2015/internal/Observable.js + 3 modules
var Observable = __webpack_require__(574);
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/observable/combineLatest.js
...
function combineLatest(...observables) {
  ...
  if ((0,isScheduler/* isScheduler */.K)(observables[observables.length - 1])) {
  ...
  if (observables.length === 1 && (0,isArray/* isArray */.k)(observables[0])) {
    observables = observables[0];
  }

  return (0,fromArray/* fromArray */.n)(observables, scheduler).lift(new CombineLatestOperator(resultSelector));
}
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/util/EmptyError.js
...
var mergeAll = __webpack_require__(282);
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/observable/empty.js

const EMPTY = new Observable/* Observable */.y(subscriber => subscriber.complete());
function empty(scheduler) {
  return scheduler ? emptyScheduled(scheduler) : EMPTY;
}

function emptyScheduled(scheduler) {
  return new Observable/* Observable */.y(subscriber => scheduler.schedule(() => subscriber.complete()));
} //# sourceMappingURL=empty.js.map
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/observable/defer.js
...
var innerSubscribe = __webpack_require__(345);
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/switchMap.js



function switchMap(project, resultSelector) {
  if (typeof resultSelector === 'function') {
    return source => source.pipe(switchMap((a, i) => (0,from/* from */.D)(project(a, i)).pipe((0,map/* map */.U)((b, ii) => resultSelector(a, b, i, ii)))));
  }
...
class SwitchMapSubscriber extends innerSubscribe/* SimpleOuterSubscriber */.Ds {
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/util/ArgumentOutOfRangeError.js
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/take.js
...
class TakeSubscriber extends Subscriber/* Subscriber */.L {
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/startWith.js
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/scan.js
...
class ScanSubscriber extends Subscriber/* Subscriber */.L {
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/filter.js
...
class FilterSubscriber extends Subscriber/* Subscriber */.L {
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/catchError.js
...
class CatchSubscriber extends innerSubscribe/* SimpleOuterSubscriber */.Ds {
  ...
  error(err) {
    if (!this.isStopped) {
      ...
      const innerSubscription = (0,innerSubscribe/* innerSubscribe */.ft)(result, innerSubscriber);
...
var mergeMap = __webpack_require__(773);
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/concatMap.js

function concatMap(project, resultSelector) {
  return (0,mergeMap/* mergeMap */.zg)(project, resultSelector, 1);
} //# sourceMappingURL=concatMap.js.map
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/takeLast.js
...
class TakeLastSubscriber extends Subscriber/* Subscriber */.L {
  constructor(destination, total) {
    super(destination);
    this.total = total;
    this.ring = new Array();
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/throwIfEmpty.js
...
class ThrowIfEmptySubscriber extends Subscriber/* Subscriber */.L {
...
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/defaultIfEmpty.js
...
class DefaultIfEmptySubscriber extends Subscriber/* Subscriber */.L {
...
var identity = __webpack_require__(487);
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/last.js
...
function last(predicate, defaultValue) {
  ...
  return source => source.pipe(predicate ? filter((v, i) => predicate(v, i, source)) : identity/* identity */.y, takeLast(1), hasDefaultValue ? defaultIfEmpty(defaultValue) : throwIfEmpty(() => new EmptyError()));
} //# sourceMappingURL=last.js.map
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/first.js
...
function first(predicate, defaultValue) {
  const hasDefaultValue = arguments.length >= 2;
  return source => source.pipe(predicate ? filter((v, i) => predicate(v, i, source)) : identity/* identity */.y, take(1), hasDefaultValue ? defaultIfEmpty(defaultValue) : throwIfEmpty(() => new EmptyError()));
...
var Subscription = __webpack_require__(319);
;// CONCATENATED MODULE: ./node_modules/rxjs/_esm2015/internal/operators/finalize.js
...
class FinallySubscriber extends Subscriber/* Subscriber */.L {
  constructor(destination, callback) {
    super(destination);
    this.add(new Subscription/* Subscription */.w(callback));
  }

} //# sourceMappingURL=finalize.js.map
// EXTERNAL MODULE: ./node_modules/rxjs/_esm2015/internal/operators/refCount.js
var refCount = __webpack_require__(307);
;// CONCATENATED MODULE: ./node_modules/@angular/router/fesm2015/router.js
/**
...
function wrapIntoObservable(value) {
  if ((0,core_js_["ɵisObservable"])(value)) {
    return value;
  }

  if ((0,core_js_["ɵisPromise"])(value)) {
...
const activateRoutes = (rootContexts, routeReuseStrategy, forwardEvent) => (0,map/* map */.U)(t => {
...
function prioritizedGuardValue() {
  return switchMap(obs => {
    ...
    }, INITIAL_VALUE), filter(item => item !== INITIAL_VALUE), (0,map/* map */.U)(item => isUrlTree(item) ? item : item === true), //
    take(1));
  });
}
/**
...
let ɵEmptyOutletComponent = /*#__PURE__*/(() => {
  ...
  ɵEmptyOutletComponent.ɵcmp = /*@__PURE__*/core_js_["ɵɵdefineComponent"]({
    ...
    template: function ɵEmptyOutletComponent_Template(rf, ctx) {
      if (rf & 1) {
        core_js_["ɵɵelement"](0, "router-outlet");
      }
    },
    directives: function () {
      return [RouterOutlet];
...
function noMatch$1(segmentGroup) {
  return new Observable/* Observable */.y(obs => obs.error(new NoMatch(segmentGroup)));
}

function absoluteRedirect(newTree) {
  return new Observable/* Observable */.y(obs => obs.error(new AbsoluteRedirect(newTree)));
}

function namedOutletsRedirect(redirectTo) {
  return new Observable/* Observable */.y(obs => obs.error(new Error(`Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`)));
}

function canLoadFails(route) {
  return new Observable/* Observable */.y(obs => obs.error(navigationCancelingError(`Cannot load children because the guard of the route "path: '${route.path}'" returned false`)));
}
/**
...
class ApplyRedirects {
  constructor(moduleInjector, configLoader, urlSerializer, urlTree, config) {
    ...
    this.ngModule = moduleInjector.get(core_js_.NgModuleRef);
  }
  ...
  apply() {
    ...
    const urlTrees$ = expanded$.pipe((0,map/* map */.U)(rootSegmentGroup => {
  ...
  match(tree) {
    ...
    const mapped$ = expanded$.pipe((0,map/* map */.U)(rootSegmentGroup => {
  ...
  expandSegmentGroup(ngModule, routes, segmentGroup, outlet) {
    if (segmentGroup.segments.length === 0 && segmentGroup.hasChildren()) {
      return this.expandChildren(ngModule, routes, segmentGroup).pipe((0,map/* map */.U)(children => new UrlSegmentGroup([], children)));
    }
  ...
  expandChildren(ngModule, routes, segmentGroup) {
    ...
    return (0,from/* from */.D)(childOutlets).pipe(concatMap(childOutlet => {
      ...
      return this.expandSegmentGroup(ngModule, sortedRoutes, child, childOutlet).pipe((0,map/* map */.U)(s => ({
        segment: s,
        outlet: childOutlet
      })));
  ...
  expandSegment(ngModule, segmentGroup, routes, segments, outlet, allowRedirects) {
    return (0,from/* from */.D)(routes).pipe(concatMap(r => {
  ...
  expandWildCardWithParamsAgainstRouteUsingRedirect(ngModule, routes, route, outlet) {
    ...
    return this.lineralizeSegments(route, newTree).pipe((0,mergeMap/* mergeMap */.zg)(newSegments => {
  ...
  matchSegmentAgainstRoute(ngModule, rawSegmentGroup, route, segments, outlet) {
    if (route.path === '**') {
      if (route.loadChildren) {
        ...
        return loaded$.pipe((0,map/* map */.U)(cfg => {
    ...
    return childConfig$.pipe((0,mergeMap/* mergeMap */.zg)(routerConfig => {
      ...
      if (slicedSegments.length === 0 && segmentGroup.hasChildren()) {
        ...
        return expanded$.pipe((0,map/* map */.U)(children => new UrlSegmentGroup(consumedSegments, children)));
      }
      ...
      return expanded$.pipe((0,map/* map */.U)(cs => new UrlSegmentGroup(consumedSegments.concat(cs.segments), cs.children)));
    }));
  }
  ...
  getChildConfig(ngModule, route, segments) {
    ...
    if (route.loadChildren) {
      ...
      return this.runCanLoadGuards(ngModule.injector, route, segments).pipe((0,mergeMap/* mergeMap */.zg)(shouldLoadResult => {
        if (shouldLoadResult) {
          return this.configLoader.load(ngModule.injector, route).pipe((0,map/* map */.U)(cfg => {
            route._loadedConfig = cfg;
            return cfg;
          }));
        }
  ...
  runCanLoadGuards(moduleInjector, route, segments) {
    ...
    const canLoadObservables = canLoad.map(injectionToken => {
      ...
      } else if (router_isFunction(guard)) {
...
function applyRedirects$1(moduleInjector, configLoader, urlSerializer, config) {
  return switchMap(t => applyRedirects(moduleInjector, configLoader, urlSerializer, t.extractedUrl, config).pipe((0,map/* map */.U)(urlAfterRedirects => Object.assign(Object.assign({}, t), {
    urlAfterRedirects
  }))));
}
/**
...
function checkGuards(moduleInjector, forwardEvent) {
  return (0,mergeMap/* mergeMap */.zg)(t => {
    const {
      targetSnapshot,
      currentSnapshot,
      guards: {
    ...
    return runCanDeactivateChecks(canDeactivateChecks, targetSnapshot, currentSnapshot, moduleInjector).pipe((0,mergeMap/* mergeMap */.zg)(canDeactivate => {
    ...
    }), (0,map/* map */.U)(guardsResult => Object.assign(Object.assign({}, t), {
      guardsResult
    })));
  });
}
...
function runCanDeactivateChecks(checks, futureRSS, currRSS, moduleInjector) {
  return (0,from/* from */.D)(checks).pipe((0,mergeMap/* mergeMap */.zg)(check => runCanDeactivate(check.component, check.route, currRSS, futureRSS, moduleInjector)), first(result => {
    return result !== true;
  }, true));
}

function runCanActivateChecks(futureSnapshot, checks, moduleInjector, forwardEvent) {
  return (0,from/* from */.D)(checks).pipe(concatMap(check => {
...
function newObservableError(e) {
  ...
  return new Observable/* Observable */.y(obs => obs.error(e));
}
...
function recognize$1(rootComponentType, config, serializer, paramsInheritanceStrategy, relativeLinkResolution) {
  return (0,mergeMap/* mergeMap */.zg)(t => recognize(rootComponentType, config, t.urlAfterRedirects, serializer(t.urlAfterRedirects), paramsInheritanceStrategy, relativeLinkResolution).pipe((0,map/* map */.U)(targetSnapshot => Object.assign(Object.assign({}, t), {
    targetSnapshot
  }))));
}
/**
...
function resolveData(paramsInheritanceStrategy, moduleInjector) {
  return (0,mergeMap/* mergeMap */.zg)(t => {
    ...
    return (0,from/* from */.D)(canActivateChecks).pipe(concatMap(check => runResolve(check.route, targetSnapshot, paramsInheritanceStrategy, moduleInjector)), tap(() => canActivateChecksResolved++), takeLast(1), (0,mergeMap/* mergeMap */.zg)(_ => canActivateChecksResolved === canActivateChecks.length ? of(t) : EMPTY));
  });
}

function runResolve(futureARS, futureRSS, paramsInheritanceStrategy, moduleInjector) {
  const resolve = futureARS._resolve;
  return resolveNode(resolve, futureARS, futureRSS, moduleInjector).pipe((0,map/* map */.U)(resolvedData => {
...
function resolveNode(resolve, futureARS, futureRSS, moduleInjector) {
  ...
  const data = {};
  return (0,from/* from */.D)(keys).pipe((0,mergeMap/* mergeMap */.zg)(key => getResolver(resolve[key], futureARS, futureRSS, moduleInjector).pipe(tap(value => {
    data[key] = value;
  }))), takeLast(1), (0,mergeMap/* mergeMap */.zg)(() => {
...
const ROUTES = /*#__PURE__*/new core_js_.InjectionToken('ROUTES');
...
class RouterConfigLoader {
  ...
  load(parentInjector, route) {
    ...
    const loadRunner = moduleFactory$.pipe((0,map/* map */.U)(factory => {
      ...
      return new LoadedRouterConfig(flatten(module.injector.get(ROUTES, undefined, core_js_.InjectFlags.Self | core_js_.InjectFlags.Optional)).map(standardizeConfig), module);
    }), catchError(err => {
      route._loader$ = undefined;
      throw err;
    })); // Use custom ConnectableObservable as share in runners pipe increasing the bundle size too much

    route._loader$ = new ConnectableObservable/* ConnectableObservable */.c(loadRunner, () => new Subject/* Subject */.xQ()).pipe((0,refCount/* refCount */.x)());
    return route._loader$;
  }

  loadModuleFactory(loadChildren) {
    if (typeof loadChildren === 'string') {
      return (0,from/* from */.D)(this.loader.load(loadChildren));
    } else {
      return wrapIntoObservable(loadChildren()).pipe((0,mergeMap/* mergeMap */.zg)(t => {
        if (t instanceof core_js_.NgModuleFactory) {
          return of(t);
        } else {
          return (0,from/* from */.D)(this.compiler.compileModuleAsync(t));
        }
      }));
    }
  }
...
let Router = /*#__PURE__*/(() => {
  class Router {
    ...
    constructor(rootComponentType, urlSerializer, rootContexts, location, injector, loader, compiler, config) {
      ...
      this.events = new Subject/* Subject */.xQ();
      /**
      ...
      this.ngModule = injector.get(core_js_.NgModuleRef);
      this.console = injector.get(core_js_["ɵConsole"]);
      const ngZone = injector.get(core_js_.NgZone);
      this.isNgZoneEnabled = ngZone instanceof core_js_.NgZone && core_js_.NgZone.isInAngularZone();
    ...
    setupNavigations(transitions) {
      ...
      (0,map/* map */.U)(t => Object.assign(Object.assign({}, t), {
      ...
      switchMap(t => {
        ...
        tap(t => {
          ...
          if (processCurrentUrl) {
            ...
            recognize$1(this.rootComponentType, this.config, url => this.serializeUrl(url), this.paramsInheritanceStrategy, this.relativeLinkResolution), // Update URL if in `eager` update mode
            tap(t => {
              if (this.urlUpdateStrategy === 'eager') {
                if (!t.extras.skipLocationChange) {
                  this.setBrowserUrl(t.urlAfterRedirects, t); // TODO(atscott): The above line is incorrect. It sets the url to
        ...
        tap(t => {
          ...
          if (!completed && !errored) {
            ...
            if (this.canceledNavigationResolution === 'replace') {
              ...
              this.cancelNavigationTransition(t, cancelationReason); // TODO(atscott): The same problem happens here with a fresh page load
    ...
    getTransition() {
      const transition = this.transitions.value; // TODO(atscott): This comment doesn't make it clear why this value needs to be set. In the case
    ...
    setUpLocationChangeListener() {
      ...
      if (!this.locationSubscription) {
        this.locationSubscription = this.location.subscribe(event => {
          const currentChange = this.extractLocationChangeInfoFromEvent(event); // The `setTimeout` was added in #12160 and is likely to support Angular/AngularJS
          // hybrid apps.
    ...
    navigateByUrl(url, extras = {
      ...
      if (typeof ngDevMode === 'undefined' || ngDevMode && this.isNgZoneEnabled && !core_js_.NgZone.isInAngularZone()) {
    ...
    scheduleNavigation(rawUrl, source, restoredState, extras, priorPromise) {
      ...
      const lastNavigation = this.getTransition(); // We don't want to skip duplicate successful navs if they're imperative because
      ...
      const lastNavigationSucceeded = this.lastSuccessfulId === lastNavigation.id; // If the last navigation succeeded or is in flight, we can use the rawUrl as the comparison.
      // However, if it failed, we should compare to the final result (urlAfterRedirects).

      const lastNavigationUrl = lastNavigationSucceeded || this.currentNavigation ? lastNavigation.rawUrl : lastNavigation.urlAfterRedirects;
  ...
  Router.ɵfac = function Router_Factory(t) {
    return new (t || Router)(core_js_["ɵɵinject"](core_js_.Type), core_js_["ɵɵinject"](UrlSerializer), core_js_["ɵɵinject"](ChildrenOutletContexts), core_js_["ɵɵinject"](common_js_.Location), core_js_["ɵɵinject"](core_js_.Injector), core_js_["ɵɵinject"](core_js_.NgModuleFactoryLoader), core_js_["ɵɵinject"](core_js_.Compiler), core_js_["ɵɵinject"](undefined));
  };

  Router.ɵprov = /*@__PURE__*/core_js_["ɵɵdefineInjectable"]({
    token: Router,
    factory: Router.ɵfac
  });
  return Router;
...
let RouterLink = /*#__PURE__*/(() => {
  class RouterLink {
    constructor(router, route, tabIndex, renderer, el) {
      ...
      this.onChanges = new Subject/* Subject */.xQ();
  ...
  RouterLink.ɵfac = function RouterLink_Factory(t) {
    return new (t || RouterLink)(core_js_["ɵɵdirectiveInject"](Router), core_js_["ɵɵdirectiveInject"](ActivatedRoute), core_js_["ɵɵinjectAttribute"]('tabindex'), core_js_["ɵɵdirectiveInject"](core_js_.Renderer2), core_js_["ɵɵdirectiveInject"](core_js_.ElementRef));
  };

  RouterLink.ɵdir = /*@__PURE__*/core_js_["ɵɵdefineDirective"]({
    type: RouterLink,
    selectors: [["", "routerLink", "", 5, "a", 5, "area"]],
    hostBindings: function RouterLink_HostBindings(rf, ctx) {
      if (rf & 1) {
        core_js_["ɵɵlistener"]("click", function RouterLink_click_HostBindingHandler() {
          return ctx.onClick();
        });
      }
    },
...
let RouterLinkWithHref = /*#__PURE__*/(() => {
  ...
  RouterLinkWithHref.ɵfac = function RouterLinkWithHref_Factory(t) {
    return new (t || RouterLinkWithHref)(core_js_["ɵɵdirectiveInject"](Router), core_js_["ɵɵdirectiveInject"](ActivatedRoute), core_js_["ɵɵdirectiveInject"](common_js_.LocationStrategy));
  };

  RouterLinkWithHref.ɵdir = /*@__PURE__*/core_js_["ɵɵdefineDirective"]({
    type: RouterLinkWithHref,
    selectors: [["a", "routerLink", ""], ["area", "routerLink", ""]],
    hostVars: 2,
    hostBindings: function RouterLinkWithHref_HostBindings(rf, ctx) {
      if (rf & 1) {
        core_js_["ɵɵlistener"]("click", function RouterLinkWithHref_click_HostBindingHandler($event) {
          return ctx.onClick($event.button, $event.ctrlKey, $event.shiftKey, $event.altKey, $event.metaKey);
        });
      }

      if (rf & 2) {
        core_js_["ɵɵhostProperty"]("href", ctx.href, core_js_["ɵɵsanitizeUrl"]);
        core_js_["ɵɵattribute"]("target", ctx.target);
      }
    },
    inputs: {
      routerLink: "routerLink",
...
let RouterLinkActive = /*#__PURE__*/(() => {
  class RouterLinkActive {
    ...
    ngAfterContentInit() {
      ...
      of(this.links.changes, this.linksWithHrefs.changes, of(null)).pipe((0,mergeAll/* mergeAll */.J)()).subscribe(_ => {
        this.update();
  ...
  RouterLinkActive.ɵfac = function RouterLinkActive_Factory(t) {
    return new (t || RouterLinkActive)(core_js_["ɵɵdirectiveInject"](Router), core_js_["ɵɵdirectiveInject"](core_js_.ElementRef), core_js_["ɵɵdirectiveInject"](core_js_.Renderer2), core_js_["ɵɵdirectiveInject"](core_js_.ChangeDetectorRef), core_js_["ɵɵdirectiveInject"](RouterLink, 8), core_js_["ɵɵdirectiveInject"](RouterLinkWithHref, 8));
  };

  RouterLinkActive.ɵdir = /*@__PURE__*/core_js_["ɵɵdefineDirective"]({
    type: RouterLinkActive,
    selectors: [["", "routerLinkActive", ""]],
    contentQueries: function RouterLinkActive_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        core_js_["ɵɵcontentQuery"](dirIndex, RouterLink, 5);
        core_js_["ɵɵcontentQuery"](dirIndex, RouterLinkWithHref, 5);
      }

      if (rf & 2) {
        let _t;

        core_js_["ɵɵqueryRefresh"](_t = core_js_["ɵɵloadQuery"]()) && (ctx.links = _t);
        core_js_["ɵɵqueryRefresh"](_t = core_js_["ɵɵloadQuery"]()) && (ctx.linksWithHrefs = _t);
      }
    },
    inputs: {
...
let RouterOutlet = /*#__PURE__*/(() => {
  class RouterOutlet {
    constructor(parentContexts, location, resolver, name, changeDetector) {
      ...
      this.activateEvents = new core_js_.EventEmitter();
      this.deactivateEvents = new core_js_.EventEmitter();
  ...
  RouterOutlet.ɵfac = function RouterOutlet_Factory(t) {
    return new (t || RouterOutlet)(core_js_["ɵɵdirectiveInject"](ChildrenOutletContexts), core_js_["ɵɵdirectiveInject"](core_js_.ViewContainerRef), core_js_["ɵɵdirectiveInject"](core_js_.ComponentFactoryResolver), core_js_["ɵɵinjectAttribute"]('name'), core_js_["ɵɵdirectiveInject"](core_js_.ChangeDetectorRef));
  };

  RouterOutlet.ɵdir = /*@__PURE__*/core_js_["ɵɵdefineDirective"]({
    type: RouterOutlet,
...
let RouterPreloader = /*#__PURE__*/(() => {
  class RouterPreloader {
    ...
    preload() {
      const ngModule = this.injector.get(core_js_.NgModuleRef);
    ...
    processRoutes(ngModule, routes) {
      ...
      return (0,from/* from */.D)(res).pipe((0,mergeAll/* mergeAll */.J)(), (0,map/* map */.U)(_ => void 0));
    }

    preloadConfig(ngModule, route) {
      return this.preloadingStrategy.preload(route, () => {
        const loaded$ = route._loadedConfig ? of(route._loadedConfig) : this.loader.load(ngModule.injector, route);
        return loaded$.pipe((0,mergeMap/* mergeMap */.zg)(config => {
  ...
  RouterPreloader.ɵfac = function RouterPreloader_Factory(t) {
    return new (t || RouterPreloader)(core_js_["ɵɵinject"](Router), core_js_["ɵɵinject"](core_js_.NgModuleFactoryLoader), core_js_["ɵɵinject"](core_js_.Compiler), core_js_["ɵɵinject"](core_js_.Injector), core_js_["ɵɵinject"](PreloadingStrategy));
  };

  RouterPreloader.ɵprov = /*@__PURE__*/core_js_["ɵɵdefineInjectable"]({
...
let RouterScroller = /*#__PURE__*/(() => {
  ...
  RouterScroller.ɵfac = function RouterScroller_Factory(t) {
    return new (t || RouterScroller)(core_js_["ɵɵinject"](Router), core_js_["ɵɵinject"](common_js_.ViewportScroller), core_js_["ɵɵinject"](undefined));
  };

  RouterScroller.ɵprov = /*@__PURE__*/core_js_["ɵɵdefineInjectable"]({
...
const ROUTER_CONFIGURATION = /*#__PURE__*/new core_js_.InjectionToken('ROUTER_CONFIGURATION');
/**
 * @docsNotRequired
 */

const ROUTER_FORROOT_GUARD = /*#__PURE__*/new core_js_.InjectionToken('ROUTER_FORROOT_GUARD');
const ɵ0 = {
  enableTracing: false
};
const ROUTER_PROVIDERS = [common_js_.Location, {
  provide: UrlSerializer,
  useClass: DefaultUrlSerializer
}, {
  provide: Router,
  useFactory: setupRouter,
  deps: [UrlSerializer, ChildrenOutletContexts, common_js_.Location, core_js_.Injector, core_js_.NgModuleFactoryLoader, core_js_.Compiler, ROUTES, ROUTER_CONFIGURATION, [UrlHandlingStrategy, /*#__PURE__*/new core_js_.Optional()], [RouteReuseStrategy, /*#__PURE__*/new core_js_.Optional()]]
}, ChildrenOutletContexts, {
  provide: ActivatedRoute,
  useFactory: rootRoute,
  deps: [Router]
}, {
  provide: core_js_.NgModuleFactoryLoader,
  useClass: core_js_.SystemJsNgModuleLoader
...
function routerNgProbeToken() {
  return new core_js_.NgProbeToken('Router', Router);
}
/**
 * @description
 *
...
let RouterModule = /*#__PURE__*/(() => {
    ...
    static forRoot(routes, config) {
      return {
        ...
        providers: [ROUTER_PROVIDERS, provideRoutes(routes), {
          ...
          deps: [[Router, new core_js_.Optional(), new core_js_.SkipSelf()]]
        }, {
          provide: ROUTER_CONFIGURATION,
          useValue: config ? config : {}
        }, {
          provide: common_js_.LocationStrategy,
          useFactory: provideLocationStrategy,
          deps: [common_js_.PlatformLocation, [new core_js_.Inject(common_js_.APP_BASE_HREF), new core_js_.Optional()], ROUTER_CONFIGURATION]
        }, {
          provide: RouterScroller,
          useFactory: createRouterScroller,
          deps: [Router, common_js_.ViewportScroller, ROUTER_CONFIGURATION]
        }, {
          provide: PreloadingStrategy,
          useExisting: config && config.preloadingStrategy ? config.preloadingStrategy : NoPreloading
        }, {
          provide: core_js_.NgProbeToken,
          multi: true,
  ...
  RouterModule.ɵfac = function RouterModule_Factory(t) {
    return new (t || RouterModule)(core_js_["ɵɵinject"](ROUTER_FORROOT_GUARD, 8), core_js_["ɵɵinject"](Router, 8));
  };

  RouterModule.ɵmod = /*@__PURE__*/core_js_["ɵɵdefineNgModule"]({
    type: RouterModule
  });
  RouterModule.ɵinj = /*@__PURE__*/core_js_["ɵɵdefineInjector"]({});
  return RouterModule;
})();
...
/*#__PURE__*/
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && core_js_["ɵɵsetNgModuleScope"](RouterModule, {
...
function provideLocationStrategy(platformLocationStrategy, baseHref, options = {}) {
  return options.useHash ? new common_js_.HashLocationStrategy(platformLocationStrategy, baseHref) : new common_js_.PathLocationStrategy(platformLocationStrategy, baseHref);
}
...
function provideRoutes(routes) {
  return [{
    provide: core_js_.ANALYZE_FOR_ENTRY_COMPONENTS,
    multi: true,
    useValue: routes
  }, {
    provide: ROUTES,
...
let RouterInitializer = /*#__PURE__*/(() => {
  class RouterInitializer {
    constructor(injector) {
      ...
      this.resultOfPreactivationDone = new Subject/* Subject */.xQ();
    }

    appInitializer() {
      const p = this.injector.get(common_js_.LOCATION_INITIALIZED, Promise.resolve(null));
      return p.then(() => {
    ...
    bootstrapListener(bootstrappedComponentRef) {
      ...
      const router = this.injector.get(Router);
      const ref = this.injector.get(core_js_.ApplicationRef);
  ...
  RouterInitializer.ɵfac = function RouterInitializer_Factory(t) {
    return new (t || RouterInitializer)(core_js_["ɵɵinject"](core_js_.Injector));
  };

  RouterInitializer.ɵprov = /*@__PURE__*/core_js_["ɵɵdefineInjectable"]({
...
const ROUTER_INITIALIZER = /*#__PURE__*/new core_js_.InjectionToken('Router Initializer');
...
function provideRouterInitializer() {
  return [RouterInitializer, {
    ...
    provide: core_js_.APP_BOOTSTRAP_LISTENER,
    multi: true,
